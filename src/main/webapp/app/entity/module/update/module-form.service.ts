...
type ModuleFormGroupContent = {
  ...
  code: FormControl<IModule['code']>;
  name: FormControl<IModule['name']>;
  description: FormControl<IModule['description']>;
  analysisType: FormControl<IModule['analysisType'] | ''>;
  allowManualOutcome: FormControl<IModule['allowManualOutcome'] | ''>;
  status: FormControl<IModule['status'] | ''>;
  configAverageTimeLimit: FormControl<IModule['configAverageTimeLimit'] | ''>;
  configEligibilityThreshold: FormControl<IModule['configEligibilityThreshold'] | ''>;
  configEvaluationType: FormControl<IModule['configEvaluationType'] | ''>;
  configExcludePlannedShutdown: FormControl<IModule['configExcludePlannedShutdown'] | ''>;
  configExcludeUnplannedShutdown: FormControl<IModule['configExcludeUnplannedShutdown'] | ''>;
  configTolerance: FormControl<IModule['configTolerance'] | ''>;
  configInstitutionCount: FormControl<IModule['configInstitutionCount'] | ''>;
  configTransactionCount: FormControl<IModule['configTransactionCount'] | ''>;
  configInstitutionTolerance: FormControl<IModule['configInstitutionTolerance'] | ''>;
  configTransactionTolerance: FormControl<IModule['configTransactionTolerance'] | ''>;
  configNotificationTolerance: FormControl<IModule['configNotificationTolerance'] | ''>;
};

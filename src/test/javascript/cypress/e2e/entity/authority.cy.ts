...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'd71cff91-aeab-498c-997d-1e80d3e1274d' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('e8a9d95c-c465-44e0-92f8-36701cdbba14');
      cy.get(`[data-cy="name"]`).should('have.value', 'e8a9d95c-c465-44e0-92f8-36701cdbba14');
